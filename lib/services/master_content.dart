...
const kFallbackRaffleSections = <RaffleTermsSection>[
  RaffleTermsSection(title: '응모 방법', items: [
    ...
    '한 회차에 여러 장 응모할 수 있고, 장수만큼 마일리지가 차감돼요. 한 번에 최대 20장이에요.',
    '여러 장 넣으면 뽑힐 확률이 장수만큼 올라가요. 다만 한 회차에서 두 번 당첨되지는 않아요.',
    '보유 마일리지가 부족하면 응모할 수 없어요.',
  ]),
  RaffleTermsSection(title: '추첨과 발표', items: [
    '마감 시각(오전 11시)이 지나면 추첨해요.',
    '두 식사권 모두 응모자 중 무작위로 추첨해요. 응모 장수가 많을수록 확률이 올라가요.',
