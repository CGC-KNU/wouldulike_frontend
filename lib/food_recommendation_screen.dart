...
class FoodRecommendationScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    List<List<Map<String, String>>> foodData = [
      ...
      [
        {"image": "assets/images/food_image1.png", "title": "한방 닭 백숙", "description": "한약재의 깊은 풍미가 더해져 건강에 좋고, 특히 체력 회복과 면역력 강화에 효과적입니다! 담백하고 진한 국물로 몸을 녹여보아요."},
        {"image": "assets/images/food_image2.png", "title": "영양 고추장 불고기", "description": "매콤달콤한 양념이 입맛을 돋구며 고단백질로 영양을 채워줍니다."},
        {"image": "assets/images/food_image3.png", "title": "김치 볶음밥", "description": "한국인의 소울푸드, 고소한 참기름과 김치의 만남! 간단하지만 맛있는 한 끼 식사입니다."}
      ],
    ];

    // 현재 유형에 맞는 데이터 선택
    List<Map<String, String>> selectedFoods = foodData[resultMessage == "1형" ? 0 : 1]; // 예시로 1형과 2형만 처리
                      ...
                      children: [
                        ...
                        ClipRRect(
                          ...
                          child: Image.asset(
                            ...
                            fit: BoxFit.cover, // 이미지를 카드 영역 전체에 맞게 채움
                          ),
                        ),
                        // 텍스트 영역
                        Align(
                          alignment: Alignment.bottomLeft, // 텍스트를 카드 하단에 배치
                          child: Container(
                            padding: const EdgeInsets.all(16.0),
                            decoration: BoxDecoration(
